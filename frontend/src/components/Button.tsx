...
export function AddButton(props: React.ButtonHTMLAttributes<HTMLButtonElement>) {
  return (<button className="btn btn-outline btn-primary btn-sm" {...props}>{plusIcon}</button>)
}

export function RemoveButton(props: React.ButtonHTMLAttributes<HTMLButtonElement>) {
  return (<button className="btn btn-outline btn-primary btn-sm" {...props}>{removeIcon}</button>)
}